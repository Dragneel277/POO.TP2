...
public class EpassJovem extends PasseStandard implements TituloTransporte {
    ...
    public EpassJovem(double saldo, double precoViagem, LocalDate dataCarrega, LocalDate dataValida, DocumentoID docId,
    ...
    public void Carregar(double saldo) {
        if(saldo>0){//confirma se a pessoa esta a meter pelo menos 1 de saldo no cartao
            ...
            if(this.getSaldo()>2400){//parti do inicio que para a pessoa carregar o pass por um mes tem que ter um valor de 2400 
                this.setSaldo(getSaldo()-2400);//subtrai 2400 no valor de saldo
